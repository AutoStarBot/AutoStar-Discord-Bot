//The button when someone smashes on the sfw genshin smash or pass game 
...
module.exports = {
    ...
    async execute(interaction) {
        try {
            ...
            // Find the person being smashed and update their count
            ...
            const embedmeme = new EmbedBuilder()
                .setColor('#FFC0CB')
                .setTitle(person.filename.slice(4).replace(/\..*/, '').replace(/-/g, ' ') + ' I SFW Genshin')
