    ...
    async execute(interaction) {
        try {
            ...
            if (numbers.length < imageFiles.length) {
                ...
                console.log(chalk.magenta('sfwgenshinsmash.txt updated successfully.'));
            }
            ...
            if (numbers2.length < imageFiles.length) {
                ...
                console.log(chalk.magenta('sfwgenshinpass.txt updated successfully.'));
            }
            ...
            const embedmeme = new EmbedBuilder()
                .setColor('#FFC0CB')
                .setTitle(person.filename.slice(4).replace(/\..*/, '').replace(/[-_]/g, ' ') + ' I SFW Genshin')
