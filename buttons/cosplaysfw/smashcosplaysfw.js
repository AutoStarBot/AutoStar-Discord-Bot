//The button when someone smashes on the sfw cosplay smash or pass game 
    ...
    async execute(interaction) {
        try {
            ...
            const embedmeme = new EmbedBuilder()
                .setColor('#FFC0CB')
                .setTitle(randomPerson.filename.slice(4).replace(/\..*/, '').replace(/-/g, ' ') + ' I SFW Cosplay')
