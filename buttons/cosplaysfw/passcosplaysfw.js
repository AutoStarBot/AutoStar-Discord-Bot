//The button when someone passes on the sfw cosplay smash or pass game 
        ...
        try {
            ...
            if (person2) {
                ...
                const embedmeme = new EmbedBuilder()
                    .setColor('#FFC0CB')
                    .setTitle(people[person].filename.slice(4).replace(/\..*/, '').replace(/-/g, ' ') + ' I SFW Cosplay')
                ...
                await interaction.update({
                    embeds: [embedmeme],
                    files: ['./smash/CosplaySFW/' + people[person].filename],
                    components: [row]
                });
            } else {
