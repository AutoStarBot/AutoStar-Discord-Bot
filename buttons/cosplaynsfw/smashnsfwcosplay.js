//The button when someone smashes on the nsfw cosplay smash or pass game 
...
module.exports = {
    name: 'smashnsfwcosplay',
    cooldown: 5,
    async execute(interaction) {
        try {
            const folderPath = 'smash/CosplayNSFW';
            const numbersFilePath = './smash/nsfwcosplaysmash.txt';
            const numbersFilePath2 = './smash/nsfwcosplaypass.txt';
            ...
            // Read and update the smash numbers file
            ...
            if (numbers.length < imageFiles.length) {
                ...
                console.log(chalk.hex('#b700ff')('nsfwcosplaysmash.txt updated successfully.'));
            }

            // Read and update the pass numbers file
            ...
            if (numbers2.length < imageFiles.length) {
                ...
                console.log(chalk.hex('#b700ff')('nsfwcosplaypass.txt updated successfully.'));
            }
            ...
            if (person2) {
                ...
                const row = new ActionRowBuilder()
                    .addComponents(
                        new ButtonBuilder()
                            ...
                            .setStyle('Secondary'),
                        new ButtonBuilder()
                            .setCustomId('passnsfwcosplay')
                            .setLabel('Pass')
                            .setStyle('Danger'),
                        new ButtonBuilder()
                            .setCustomId('smashnsfwcosplay')
                            .setLabel('Smash')
                            .setStyle('Success'),
                        new ButtonBuilder()
                ...
                const embedmeme = new EmbedBuilder()
                    .setColor('#FFC0CB')
                    .setTitle(people[person].filename.slice(4).replace(/\..*/, '').replace(/-/g, ' ') + ' I NSFW Cosplay')
                ...
                await interaction.update({
                    embeds: [embedmeme],
                    files: ['./smash/CosplayNSFW/' + people[person].filename],
                    components: [row]
                });
            } else {
