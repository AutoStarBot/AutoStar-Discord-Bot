//Response if someone reports an image as being in the wrong category
...
module.exports = {
	...
	async execute(interaction) {
        ...
        alertMessage.setTitle('New Report: Image In Wrong Category')
        ...
        embedmeme.setTitle(`File Reported For Having Wrong Category`)
