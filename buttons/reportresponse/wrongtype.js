//Response if someone reports an image as being in the wrong type
...
module.exports = {
	...
	async execute(interaction) {
        ...
        alertMessage.setTitle('New Report: Image In Wrong Type')
        ...
        embedmeme.setTitle(`File Reported For Being Marked As Wrong Type`)
